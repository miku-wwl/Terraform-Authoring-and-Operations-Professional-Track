...
HCP Terraform、Terraform Cloud、认证规则、价格、平台 UI、权限治理等以选择题为主的考试理论 session，可以生成“知识点讲解 + 考试选择题 + 判断题 + 场景题 + 参考答案与解析”。这类内容的目标是考试训练，不创建无意义的 Docker lab。
...
- Professional level
- Docker 实操 lab 不做选择题；纯理论或认证题型 session 可以按考试训练方式生成选择题、判断题和场景题
