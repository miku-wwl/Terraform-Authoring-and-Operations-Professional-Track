...
aws --endpoint-url=$endpoint s3 rm s3://tf-pro-lab-102-dev --recursive 2>$null
aws --endpoint-url=$endpoint s3api delete-bucket --bucket tf-pro-lab-102-dev 2>$null
aws --endpoint-url=$endpoint s3 rm s3://tf-pro-lab-102-prod --recursive 2>$null
aws --endpoint-url=$endpoint s3api delete-bucket --bucket tf-pro-lab-102-prod 2>$null
