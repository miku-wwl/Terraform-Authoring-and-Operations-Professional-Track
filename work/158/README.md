# 第 158 节做题环境：挑战二解法一：模块化 S3 与 IAM 资源

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/158/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\158
