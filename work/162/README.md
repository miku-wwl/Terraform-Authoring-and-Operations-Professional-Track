# 第 162 节做题环境：挑战三解法二：分阶段应用 local_file 与 AWS 资源

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/162/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\162
