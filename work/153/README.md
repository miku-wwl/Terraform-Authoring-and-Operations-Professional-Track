# 第 153 节做题环境：挑战一概览：修复代码、导入、输出与状态管理

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/153/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\153
```
