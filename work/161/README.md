# 第 161 节做题环境：挑战三解法一：Provider alias、default tags 与 caller identity

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/161/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\161
