# 第 171 节做题环境：挑战八解法：数据源读取子网并生成安全组规则

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/171/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\171
