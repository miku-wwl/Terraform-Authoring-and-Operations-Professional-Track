...
本目录是 `work/22` 上机做题环境，来源于 `practice/22.md` 的实验设计。这里不是参考答案目录，你需要在当前目录内完成代码或命令练习。

核心主题：`random_integer`、唯一后缀、state 中的随机值

## 2. 任务目标

随机后缀在 1000 到 9999 之间，文件名包含该后缀。

你需要根据题目目标修复起始文件中的 `TODO`，补全随机后缀的范围，让实验通过验收。
