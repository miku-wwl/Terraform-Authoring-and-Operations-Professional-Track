# 第 168 节做题环境：挑战五解法三：模块重构 VPC / SG 结构

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/168/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\168
