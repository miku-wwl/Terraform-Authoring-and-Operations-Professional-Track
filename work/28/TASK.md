...
本目录是 `work/28` 上机做题环境，来源于 `practice/28.md` 的实验设计。这里不是参考答案目录，你需要在当前目录内完成代码或命令练习。

核心主题：leading whitespace、共同缩进、相对缩进

## 2. 任务目标

输出三行 YAML，`name` 行保留两个空格。

你需要根据题目目标修复起始文件中的 `TODO`，补全 YAML 的相对缩进，让实验通过验收。
