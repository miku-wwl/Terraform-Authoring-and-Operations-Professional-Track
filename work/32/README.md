...
这是你的上机做题目录。请编辑当前目录下的 Terraform 文件，不要修改 `practice/labs/32/` 中的参考实现。
...
返回内容中看到 `sts` 是 `available` 后，再继续下一步。

## 2. 进入实验目录

```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\32
