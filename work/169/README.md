# 第 169 节做题环境：挑战六解法：AWS CLI profile、source_profile 与 provider alias

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/169/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\169
