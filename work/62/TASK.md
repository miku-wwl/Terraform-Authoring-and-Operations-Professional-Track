# Terraform 实操训练 62：基于 CSV 创建多个资源

## 1. 背景

本目录是 `work/62` 上机做题环境，来源于 `practice/62.md` 的实验设计。这里不是参考答案目录，你需要在当前目录内完成数据结构、表达式或模板练习。
...
你需要根据测试失败信息修复起始文件中的 `TODO`、错误值或不完整表达式。
