# 第 155 节做题环境：挑战一解法二：把输出保存到文件并练习状态操作

这是你的上机做题目录。请编辑当前目录，不要修改 `practice/labs/155/` 中的参考实现。
...
```powershell
cd D:\workshop\GitHub\Terraform-Authoring-and-Operations-Professional-Track\work\155
