...
本目录是 `work/21` 上机做题环境，来源于 `practice/21.md` 的实验设计。这里不是参考答案目录，你需要在当前目录内完成代码或命令练习。

核心主题：`-target`、资源地址、局部 plan/apply

## 2. 任务目标

target 命令被记录，完整 destroy 可清理所有资源。

你需要根据题目目标修复起始文件中的 `TODO`，补全 targeted plan 命令和资源总数，让实验通过验收。
